...
<div class="space-y-8">
    ...
    {{-- HEADER --}}
    {{-- ========================================= --}}
    @include('admin.event.absensi.partials.peserta._header')

    {{-- ========================================= --}}
    {{-- STATISTIK --}}
    {{-- ========================================= --}}
    @include('admin.event.absensi.partials.peserta._statistik')
    ...
    {{-- TABLE --}}
    {{-- ========================================= --}}
    @include('admin.event.absensi.partials.peserta._table')
