    ...
    <div class="grid lg:grid-cols-[1.3fr_1fr_1fr] gap-8 items-center">
        ...
        <div class="border-l border-slate-200 pl-8">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                {{-- ================================= --}}
                @if($donasi->tipe == 'sekali')
                    <a href="{{ route('donatur.donasi.show', $donasi->id) }}"
                ...
                @else
                    <a href="{{ route('donatur.donasi.detail', $donasi->id) }}"
                       class="px-7 py-4 rounded-2xl
                              border border-slate-300
                              hover:bg-slate-50">
                ...
                @if(
                    ...
                    <a href="{{ route('donatur.langganan.bulanan', $donasi->id) }}"
                       class="px-7 py-4 rounded-2xl
                              text-white font-semibold"
                ...
                @if($donasi->tipe == 'bulanan' && $donasi->langganan)
                    ...
                    @if($donasi->langganan->is_aktif)
                        ...
                        <form
                            method="POST"
                            action="{{ route('donatur.donasi.akhiri', $donasi->id) }}"
                            class="mt-3">
                    ...
                    @else
                        ...
                        <form
                            method="POST"
                            action="{{ route('donatur.donasi.aktifkan', $donasi->id) }}"
                            class="mt-3">
                ...
                @if(
                    ...
                    @if($donasi->tipe == 'sekali')
                        ...
                        <a href="{{ route('donatur.donasi.bayar', $donasi->id) }}"
                           class="px-7 py-4 rounded-2xl
                                  text-white font-semibold"
                    ...
                    {{-- BATALKAN --}}
                    <form method="POST"
                          action="{{ route('donatur.donasi.batal', $donasi->id) }}">
