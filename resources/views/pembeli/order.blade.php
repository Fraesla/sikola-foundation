                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div class="lg:col-span-3 flex flex-col justify-center gap-3">
                            ...
                            @if($order->status == 'menunggu_pembayaran')
                                <a href="{{ route('pembeli.orders.bayar',$order->id) }}"
                            ...
                            @if($order->status == 'dikirim')
                                <form action="{{ route('pembeli.orders.selesai',$order->id) }}" method="POST">
                                    @csrf
                                    <button type="submit"
                               ...
                               <!--  <a href="{{ route('pembeli.orders.komplain',$order->id) }}"
                                    ...
                                    <template x-teleport="body">
                                        <div x-show="openBatal" x-cloak x-transition.opacity class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                                            ...
                                            <div @click.away="openBatal = false" x-transition.scale
                                                ...
                                                <form action="{{ route('pembeli.orders.batal',$order->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
