@extends('layouts.pembeli', ['activePage' => 'order'])
        ...
        <div class="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm relative overflow-hidden">
            ...
            <div class="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ url('pembeli/orders') }}" class="group px-6 py-3 rounded-2xl border border-slate-200 font-bold hover:bg-slate-50 transition-all text-sm flex items-center gap-2">
